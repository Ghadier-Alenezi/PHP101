...
<form method="post" id="formArticle">
    <div>
        ...
        <input id="title" type="text" name="title" placeholder="Article Title" value="<?= htmlspecialchars($article->title); ?>">
    </div>

    <div>
        <label for="content">Content:</label>
        <textarea id="content" rows="4" cols="40" type="text" name="content" placeholder="Article Content" value="<?= htmlspecialchars($article->content); ?>"></textarea>
    </div>
